...
public class Ghost : MonoBehaviour {
    ...
    void Start() {
        ...
        _controller = _Controller.GetComponentInChildren<Controller>();
    }
	void Update () {
    ...
    private void setGhostMaterialProperties() {
        ...
        setGhostMaterialProperty(mat, "_FaceOffset_U",  -0.114286f);
        setGhostMaterialProperty(mat, "_FaceOffset_V",  -0.104762f);
        setGhostMaterialProperty(mat, "_FaceSize_U",    1.208626f);
        setGhostMaterialProperty(mat, "_FaceSize_V",    1.231869f);
        setGhostMaterialProperty(mat, "_EmissiveBody",  107.189331f);
        setGhostMaterialProperty(mat, "_EmissiveEyes",  993.68634f);
        //setGhostMaterialProperty(mat, "_WispMagnitude", 1.976086f);
        //setGhostMaterialProperty(mat, "_WispPower",     2.276606f);
        //setGhostMaterialProperty(mat, "_WispPower2",    7.521093f);
        setGhostMaterialProperty(mat, "_WispSpeed",     -0.56f);
        setGhostMaterialProperty(mat, "_WispTiling_U",  2.0f);
        setGhostMaterialProperty(mat, "_WispTiling_V",  0.1f);
    }  

    // setGhostMaterialProperty
    // Helper method to set material properties
    private void setGhostMaterialProperty(Material mat, string property, float val) {
